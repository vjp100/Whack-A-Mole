...
entity hammer_whacking_mole_sprite is
    port (
        clk   : in  std_logic;
...
end hammer_whacking_mole_sprite;

architecture Behavioral of hammer_whacking_mole_sprite is

    signal rom_addr : std_logic_vector(14 downto 0);
    signal rom_data : std_logic_vector(11 downto 0);
    
      component hammer_whacking_mole_rom 
    port(
        clka : IN STD_LOGIC;
        ena : IN STD_LOGIC;
...
begin
    ...
    u_hammer_whacking_mole_sprite : entity work.hammer_whacking_mole_rom 
        port map (
            clka  => clk,
            ena   => std_logic'('1'),
            addra => rom_addr,
