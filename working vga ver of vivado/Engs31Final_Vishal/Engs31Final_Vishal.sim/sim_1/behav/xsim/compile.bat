...
REM
REM Generated by Vivado on Mon Jun 01 22:29:49 -0400 2026
...
echo "xvhdl --incr --relax -prj JoyStick_tb_vhdl.prj"
call xvhdl  --incr --relax -prj JoyStick_tb_vhdl.prj -log xvhdl.log
