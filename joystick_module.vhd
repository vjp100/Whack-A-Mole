...
--===========================================
    ...
    right_move <= '1' when unsigned(x_axis_reg) > 800 else '0'; -- if x is greater than 612, we're moving right. => implies 100 deadzone (~7.5% of 1023) on either side of the center value of 512.
    left_move <= '1' when unsigned(x_axis_reg) < 212 else '0'; -- if x is less than 412, we're moving left.
    up <= '1' when unsigned(y_axis_reg) > 800 else '0'; -- if y is greater than 612, we're moving up.
    down <= '1' when unsigned(y_axis_reg) < 212 else '0'; -- if y is less than 412, we're moving down.
