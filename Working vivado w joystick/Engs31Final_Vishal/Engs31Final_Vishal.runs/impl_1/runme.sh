...
HD_PWD='O:/CS56/Engs31Final_Vishal/Engs31Final_Vishal.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Whack_a_mole_top_lvl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Whack_a_mole_top_lvl.tcl -notrace
