...
HD_PWD='O:/CS56/Engs31Final_Vishal/Engs31Final_Vishal.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Whack_a_mole_top_lvl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Whack_a_mole_top_lvl.tcl
