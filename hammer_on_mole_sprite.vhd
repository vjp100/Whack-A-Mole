...
entity hammer_on_mole_sprite is
    port (
        clk   : in  std_logic;
...
end hammer_on_mole_sprite;

architecture Behavioral of hammer_on_mole_sprite is
...
begin
    ...
    u_hammer_on_mole_sprite : entity work.hammer_on_mole_rom
        port map (
            clka  => clk,
            ena   => std_logic'('1'),
            addra => rom_addr,
