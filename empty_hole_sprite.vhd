...
end empty_hole_sprite;


architecture Behavioral of empty_hole_sprite is

    signal rom_addr : std_logic_vector(14 downto 0);
    signal rom_data : std_logic_vector(11 downto 0);
    
    component empty_hole_rom
    port(
        clka : IN STD_LOGIC;
        ena : IN STD_LOGIC;
...
begin
    ...
    u_empty_hole_sprite : entity work.empty_hole_rom
        port map (
            clka  => clk,
            ena   =>  std_logic'('1'),
            addra => rom_addr,
